...
immutable DXGI_CPU_ACCESS_NONE = ( 0 );
immutable DXGI_CPU_ACCESS_DYNAMIC = ( 1 );
immutable DXGI_CPU_ACCESS_READ_WRITE = ( 2 );
immutable DXGI_CPU_ACCESS_SCRATCH = ( 3 );
immutable DXGI_CPU_ACCESS_FIELD = 15;
immutable DXGI_USAGE_SHADER_INPUT = 0x00000010UL;
immutable DXGI_USAGE_RENDER_TARGET_OUTPUT = 0x00000020UL;
immutable DXGI_USAGE_BACK_BUFFER = 0x00000040UL;
immutable DXGI_USAGE_SHARED = 0x00000080UL;
immutable DXGI_USAGE_READ_ONLY = 0x00000100UL;
immutable DXGI_USAGE_DISCARD_ON_PRESENT = 0x00000200UL;
immutable DXGI_USAGE_UNORDERED_ACCESS = 0x00000400UL;
immutable DXGI_RESOURCE_PRIORITY_MINIMUM = ( 0x28000000 );
immutable DXGI_RESOURCE_PRIORITY_LOW = ( 0x50000000 );
immutable DXGI_RESOURCE_PRIORITY_NORMAL = ( 0x78000000 );
immutable DXGI_RESOURCE_PRIORITY_HIGH = ( 0xa0000000 );
immutable DXGI_RESOURCE_PRIORITY_MAXIMUM = ( 0xc8000000 );
immutable DXGI_MAP_READ = ( 1UL );
immutable DXGI_MAP_WRITE = ( 2UL );
immutable DXGI_MAP_DISCARD = ( 4UL );
immutable DXGI_ENUM_MODES_INTERLACED = ( 1UL );
immutable DXGI_ENUM_MODES_SCALING = ( 2UL );
immutable DXGI_MAX_SWAP_CHAIN_BUFFERS = ( 16 );
immutable DXGI_PRESENT_TEST = 0x00000001UL;
immutable DXGI_PRESENT_DO_NOT_SEQUENCE = 0x00000002UL;
immutable DXGI_PRESENT_RESTART = 0x00000004UL;
immutable DXGI_PRESENT_DO_NOT_WAIT = 0x00000008UL;
immutable DXGI_PRESENT_STEREO_PREFER_RIGHT = 0x00000010UL;
immutable DXGI_PRESENT_STEREO_TEMPORARY_MONO = 0x00000020UL;
immutable DXGI_PRESENT_RESTRICT_TO_OUTPUT = 0x00000040UL;
immutable DXGI_PRESENT_USE_DURATION = 0x00000100UL;
immutable DXGI_PRESENT_ALLOW_TEARING = 0x00000200UL;
immutable DXGI_MWA_NO_WINDOW_CHANGES = ( 1 << 0 );
immutable DXGI_MWA_NO_ALT_ENTER = ( 1 << 1 );
immutable DXGI_MWA_NO_PRINT_SCREEN = ( 1 << 2 );
immutable DXGI_MWA_VALID = ( 0x7 );
