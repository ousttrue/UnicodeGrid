...
enum D3D_FL9_1_REQ_TEXTURE1D_U_DIMENSION = 2048;
enum D3D_FL9_3_REQ_TEXTURE1D_U_DIMENSION = 4096;
enum D3D_FL9_1_REQ_TEXTURE2D_U_OR_V_DIMENSION = 2048;
enum D3D_FL9_3_REQ_TEXTURE2D_U_OR_V_DIMENSION = 4096;
enum D3D_FL9_1_REQ_TEXTURECUBE_DIMENSION = 512;
enum D3D_FL9_3_REQ_TEXTURECUBE_DIMENSION = 4096;
enum D3D_FL9_1_REQ_TEXTURE3D_U_V_OR_W_DIMENSION = 256;
enum D3D_FL9_1_DEFAULT_MAX_ANISOTROPY = 2;
enum D3D_FL9_1_IA_PRIMITIVE_MAX_COUNT = 65535;
enum D3D_FL9_2_IA_PRIMITIVE_MAX_COUNT = 1048575;
enum D3D_FL9_1_SIMULTANEOUS_RENDER_TARGET_COUNT = 1;
enum D3D_FL9_3_SIMULTANEOUS_RENDER_TARGET_COUNT = 4;
enum D3D_FL9_1_MAX_TEXTURE_REPEAT = 128;
enum D3D_FL9_2_MAX_TEXTURE_REPEAT = 2048;
enum D3D_FL9_3_MAX_TEXTURE_REPEAT = 8192;
enum D3D_COMPONENT_MASK_X = 1;
enum D3D_COMPONENT_MASK_Y = 2;
enum D3D_COMPONENT_MASK_Z = 4;
enum D3D_COMPONENT_MASK_W = 8;
...
interface ID3D10Blob: IUnknown {
    static immutable uuidof = GUID(0x8BA5FB08, 0x5195, 0x40e2, [0xAC, 0x58, 0x0D, 0x98, 0x9C, 0x3A, 0x01, 0x02]);
    LPVOID GetBufferPointer();
    SIZE_T GetBufferSize();
}

interface ID3DDestructionNotifier: IUnknown {
    static immutable uuidof = GUID(0xa06eb39a, 0x50da, 0x425b, [0x8c, 0x31, 0x4e, 0xec, 0xd6, 0xc2, 0x70, 0xf3]);
